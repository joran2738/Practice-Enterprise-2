...
#include <memory>
#include "../../Brickbreakers/gamefield.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GameField_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_GameField_t qt_meta_stringdata_GameField = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_GameField[] = {
...
Q_CONSTINIT const QMetaObject GameField::staticMetaObject = { {
    ...
    qt_meta_stringdata_GameField.offsetsAndSizes,
    qt_meta_data_GameField,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_GameField_t,
        // Q_OBJECT / Q_GADGET
